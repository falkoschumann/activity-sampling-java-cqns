...
import de.muspellheim.activitysampling.backend.messagehandlers.RecentActivitiesQueryHandler;
...
public class App extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    frontend.setOnRecentActivitiesQuery(
        cmd -> {
          var result = recentActivitiesQueryHandler.handle(new RecentActivitiesQuery());
          frontend.display(result);
        });

    frontend.setOnSettingsQuery(
        cmd -> {
          var result = settingsQueryHandler.handle(new SettingsQuery());
          frontend.display(result);
        });
