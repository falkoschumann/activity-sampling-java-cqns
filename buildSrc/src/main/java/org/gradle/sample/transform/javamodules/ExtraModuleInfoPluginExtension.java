...
/**
 * A data class to collect all the module information we want to add. Here the class is used as
 * extension that can be configured in the build script and as input to the ExtraModuleInfoTransform
 * that add the information to Jars.
 */
